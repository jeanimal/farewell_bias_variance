...
See the related article [EffectiveDimensions](./EffectiveDimensions.html) for empirical calculations of the dimensions in the data (the first two conditions). 
