...
As an aside, there are quite a few papers explaining how noise can act like a regularizer, but usually noise is injected as additional rows of "real data + noise" (among other ways).  I was surprised that pure noise columns also had an interesting effect.
