...
I later realized I also need to estimate the intrinsic dimension.  It takes into account the **signal** structure because effective dimension of the data does not adjust for noise.  
...
We got 7 intrinsic dimensions.  We will compare this with the other data set.
...
We got 7 dimensions again.  Noise did not affect the intrinsic dimension.  Yay!!!
